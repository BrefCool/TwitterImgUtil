...
def resize_images(images_dir):
    ...
    cmd = ['ffmpeg', '-i', os.path.join(images_dir, 'image-%05d.jpg'), '-vf', 'scale=640:480',
           os.path.join(images_dir, 'for_video', 'image-%05d.png')]
    subprocess.call(cmd)
...
def convert_images_to_video(images_dir, videos_dir):
    ...
    if image_num != 0:
        ...
        cmd = ['ffmpeg', '-start_number', '00000', '-r', '1/2', '-i', os.path.join(image_path, 'image-%05d.png'),
    ...
    for i in range(0, image_iter):
        ...
        cmd = ['ffmpeg', '-start_number', start_number, '-r', '1/2', '-i', os.path.join(image_path, 'image-%05d.png'),
